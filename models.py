...
class User(Model):
    ...
    join_date = fields.DatetimeField(default=utcnow)
...
class Business(Model):
    ...
    logo = fields.CharField(max_length=200, null=True, default="default.png")
...
class Product(Model):
    ...
    offer_expiration_date = fields.DatetimeField(default=utcnow)
    product_image = fields.CharField(max_length=200, null=False, default="productDefault.jpg")
    date_published = fields.DatetimeField(default=utcnow)
